 ...
 * @author ws
 */
@FacesConverter(value = "converterPedido")
public class ConverterPedido implements Converter, Serializable{

    // Método que converte da tela para um objeto(Pedido)
    @Override
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        try{
            return em.find(Pedido.class, Integer.parseInt(value));
        } catch (Exception e){
            return null;
        } finally{
            em.close();
